...
public class CustomerDetails extends JFrame{
    ...
    JRadioButton jCarPaint, jHeadlightChange, jWindshield, jHornBattey, jSideMirror;
    
    String       customerName, address, mobileNo, carName, carPaint, headlightChange, windshield, hornBattey, sideMirror, userName, password;
    String       admin, blank;
    ...
    public CustomerDetails(){
        ...
        jCustomerDetails = new JLabel("CUSTOMERS DETAILS");
        jCustomerDetails.setFont(new Font("Serif", Font.BOLD, 35));
        jCustomerDetails.setBorder(new EmptyBorder(0, 0, 50, 0));
        
        jCreateUsername = new JLabel("Create Username: ");
        jCreatePassword = new JLabel("Create Password: ");
        jBlank          = new JLabel("");
        ...
        jHornBattey.setText("Replace HornBattey");
            ...
            public void actionPerformed(ActionEvent e){
                ...
                try{
                    ...
                    if(!flag && !userName.equals(admin)){
                        ...
                        BillGenerate billGenerate = new BillGenerate(userName);
                    }
                    else{
        ...
        super.addComponentListener(new ComponentAdapter(){
            public void componentMoved(ComponentEvent e) {
                if (locked!=null) 
                    CustomerDetails.this.setLocation(locked);
            }
        });
