...
public class BillGenerate extends JFrame{
    
    JPanel jPanel, jPanelMain, jPanel1, jPanel2, jPanel3, jPanel4, jPanel5;
    JPanel jPanel6, jPanel7, jPanelLine, jPanel8, jPanel9, jPanel10, jPanel11, jPanel12, jPanel13;
    ...
    public BillGenerate(String userName){
        
        jBill = new JLabel("AUTO REPAIR BILL");
        ...
        jGetCusName      = new JLabel(rs.getString("CustomerName"));
        ...
        jPanel.add(jBackButton, BorderLayout.SOUTH);
